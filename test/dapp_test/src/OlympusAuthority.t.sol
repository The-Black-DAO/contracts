...
contract BlackDaoAuthorityTest is DSTest {

    BlackDaoAuthority authority;
    ...
    function test_onlyGovernor_not_authorized() public {
        authority = new BlackDaoAuthority(UNAUTHORIZED_USER, address(this), address(this), address(this));
    ...
    function test_onlyGuardian_not_authorized() public {
        authority = new BlackDaoAuthority(address(this), UNAUTHORIZED_USER, address(this), address(this));
        accessControlledMock = new AccessControlledMock( address(authority) );
    ...
    function test_onlyPolicy_not_authorized() public {
        authority = new BlackDaoAuthority(address(this), address(this), UNAUTHORIZED_USER, address(this));
        accessControlledMock = new AccessControlledMock( address(authority) );
    ...
    // TODO create tests for push/pull mechanism within BlackDaoAuthority
