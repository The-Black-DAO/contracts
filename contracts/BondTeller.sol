...
contract BondTeller is ITeller, BlackDaoAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    struct Bond {
        ...
        uint256 payout; // sBLKD remaining to be paid. agnostic balance
    ...
    IsBLKD internal immutable sBLKD; // payment token
    ...
    function newBond(
        ...
        BLKD.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        BLKD.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sBLKD.safeTransfer(_bonder, _amount);
    }
    ...
    /**
     * @notice calculate amount of BLKD available for claim for single bond
     * @param _bonder address
    ...
    /**
     * @notice calculate amount of BLKD available for claim for array of bonds
     * @param _bonder address
