...
contract BlackDaoBondDepository is BlackDaoAccessControlled {
  ...
  function deposit(
    ...
    require(payout >= 10000000, "Bond too small"); // must be > 0.01 BLKD ( underflow protection )
  ...
  /**
   * @notice calculate current ratio of debt to BLKD supply
   * @param _BID uint
